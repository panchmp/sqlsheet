...
/**
 * Wrapper around the JSQLParser which does all of the real work. This class and the rest of the interface in the package are here
 * just to insulate the parent package from the particulars of a particular parser.
 *
...
public class SqlSheetParser {
    ...
    /**
     * Excel silently truncates long sheet names to 31 chars. We may truncate table names explicitly for every usage.
     */
    ...
    public ParsedStatement parse(String sql) throws SQLException {
        ...
        if (statement instanceof Select) {
            ...
            if (selectItems == null || selectItems.isEmpty() || selectItems.size() > 1
            ...
            for (Expression exp : exps) {
                ...
                // doh
                    ...
                    throw new SQLException(
                            "Cannot handle expression of class " + exp.getClass().getName() + ", value = " + exp.toString());
                }
            }
