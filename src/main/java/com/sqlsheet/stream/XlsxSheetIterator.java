...
public class XlsxSheetIterator extends AbstractXlsSheetIterator {
      ...
      switch (event.getEventType()) {
        case XMLEvent.START_ELEMENT:
          ...
          if (nextEvent.isCharacters()) {
            ...
            if (!c.isWhiteSpace()) handler.characters(c.getData().toCharArray());
          }
          break;
   ...
   *
   * <p>Also see Standard ECMA-376, 1st edition, part 4, pages 1928ff, at
            ...
            if (this.formatString != null) {
              thisCellValue.stringValue =
                  formatter.formatRawCellContents(
                      thisCellValue.doubleValue, this.formatIndex, this.formatString);
            } else {
              thisCellValue.stringValue = n;
            }
            thisCellValue.dateValue =
                convertDateValue(thisCellValue.doubleValue, this.formatIndex, this.formatString);
            break;
          default:
