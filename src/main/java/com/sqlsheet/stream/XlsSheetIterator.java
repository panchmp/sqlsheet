...
public class XlsSheetIterator extends AbstractXlsSheetIterator implements HSSFListener {
    ...
    /**
     * Initiates the processing - position stream to the right sheet - extracts columns - extracts
     * first row
     */
        ...
        try {
            ...
            recordStream =
                    new RecordFactoryInputStream(
                            fileSystem.getRoot().createDocumentInputStream("Workbook"), false);
        ...
        switch (record.getSid()) {
            ...
            case BOFRecord.sid:
                ...
                if (br.getType() == BOFRecord.TYPE_WORKSHEET) {
                    ...
                    String quotedSheetName = "\"" + orderedBSRs[sheetIndex].getSheetname() + "\"";
                    inRequiredSheet =
                ...
                if (outputFormulaValues) {
                    if (Double.isNaN(frec.getValue())) {
                        ...
                        thisCellValue.dateValue =
                                convertDateValue(
                                        frec.getValue(),
                                        formatListener.getFormatIndex(frec),
            ...
            case NumberRecord.sid:
                ...
                thisCellValue.dateValue =
                        convertDateValue(
                                numrec.getValue(),
                                formatListener.getFormatIndex(numrec),
