...
public class dataTypeTest {
    ...
    public void dataTypeTest() throws Exception {
        ...
        Assertions.assertEquals("DATE", resultSetMetaData.getColumnTypeName(2),
                "We expect for the second DATE");
        Assertions.assertEquals("DOUBLE", resultSetMetaData.getColumnTypeName(3),
        ...
        // Null first
        Assertions.assertEquals("DATE", resultSetMetaData.getColumnTypeName(5),
                "We expect for the fifth  DATE");
        Assertions.assertEquals("DOUBLE", resultSetMetaData.getColumnTypeName(6),
                "We expect for the sixth DOUBLE");
        Assertions.assertEquals("VARCHAR", resultSetMetaData.getColumnTypeName(7),
